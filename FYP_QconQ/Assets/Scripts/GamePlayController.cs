...
public class GamePlayController : MonoBehaviour 
{
    ...
    public void EncouragingMessages(int mode)
    {
        switch (mode)
        {
            ...
            case 0:
                if (questionsRight <= 3)
                    encouragingMessageText.text = PlayerPrefs.GetString("sentence1");
                else if (questionsRight <= 6 && questionsRight > 3)
                    encouragingMessageText.text = PlayerPrefs.GetString("sentence2");
                else
                    encouragingMessageText.text = PlayerPrefs.GetString("sentence3");
                break;
    ...
    public void EndScreenProcessing(int mode)
    {
        switch (mode)
        {
            ...
            case 0:
                ...
                moneyGainedText.text = PlayerPrefs.GetString("earnings") + " " + score.ToString() + " " + PlayerPrefs.GetString("conticoins");

                //Score and % of corrects
                efficiencyPercent = questionsRight * 10.0f;
                scoreText.text = PlayerPrefs.GetString("score") + score.ToString("F0") + "\n(" + efficiencyPercent.ToString("F0") + "% " + PlayerPrefs.GetString("correct") + ")";
                break;
            ...
            case 1:
                ...
                moneyGainedText.text = PlayerPrefs.GetString("earnings") + " " + ArcadeCoinCount.ToString() + " " + PlayerPrefs.GetString("conticoins");

                //Score and no. of corrects
                efficiencyPercent = questionsRight * 10.0f;
                scoreText.text = PlayerPrefs.GetString("score") + score.ToString("F0") + "\n(" + questionsRight.ToString("F0") + "% " + PlayerPrefs.GetString("correct") + ")";
                break;
        }
