...
namespace UnityStandardAssets.ImageEffects
{
    ...
    class VignetteAndChromaticAberrationEditor : Editor
    {
        ...
        public SerializedProperty m_Intensity;             // intensity == 0 disables pre pass (optimization)
        public SerializedProperty m_ChromaticAberration;
        public SerializedProperty m_AxialAberration;
        public SerializedProperty m_Blur;                  // blur == 0 disables blur pass (optimization)
        public SerializedProperty m_BlurSpread;
        public SerializedProperty m_BlurDistance;
        public SerializedProperty m_LuminanceDependency;
